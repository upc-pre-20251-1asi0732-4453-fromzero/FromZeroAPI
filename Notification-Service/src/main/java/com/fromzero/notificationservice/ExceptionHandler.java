...
public class ExceptionHandler {
    ...
    @org.springframework.web.bind.annotation.ExceptionHandler(RuntimeException.class) // Puedes cambiar a Exception.class si quieres manejar todas las excepciones
